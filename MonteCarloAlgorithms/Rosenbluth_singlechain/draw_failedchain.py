...
positions = []
with open("failedchain_coords.txt") as f:
    for line in f:
...
ax.plot(x_coords[-1], y_coords[-1], marker='x', color='black', markersize=14, mew=3, label='Failed end')
...
# Show and/or save
plt.tight_layout()
plt.savefig("polymer_failedchain_sarw.png", dpi=300)
#plt.show()
